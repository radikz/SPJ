...
public class Filling1Fragment extends Fragment {
        ...
        noRak.setOnEditorActionListener(new AppCompatAutoCompleteTextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                if (actionId == KeyEvent.KEYCODE_FORWARD_DEL) {
                    ...
                    prefManager.deleteKey("pengisian_filling" + filling + "_" + signRakApv + "_noRak");
...
//
        ...
        noRak.setText(prefManager.catchString("pengisian_filling" +filling+ "_" +1+"_noRak"));
        tekAwal.setText(prefManager.catchString("pengisian_filling" +filling+ "_" +1+"_tekAwal"));
        tempAwal.setText(prefManager.catchString("pengisian_filling" +filling+ "_" +1+"_tempAwal"));
        pressAwal.setText(prefManager.catchString("pengisian_filling" +filling+ "_" +1+"_pressAwal"));
        sm3Awal.setText(prefManager.catchString("pengisian_filling" +filling+ "_" +1+"_sm3Awal"));
...
//
    ...
    private void fungsiCatchValue(final short rak) {
        ...
        prefManager.saveString("pengisian_filling" +filling+ "_" +pos+"_noRak", String.valueOf(noRak.getText()));
        prefManager.saveString("pengisian_filling" +filling+ "_" +pos+"_tekAwal", String.valueOf(tekAwal.getText()));
        prefManager.saveString("pengisian_filling" +filling+ "_" +pos+"_tempAwal", String.valueOf(tempAwal.getText()));
        prefManager.saveString("pengisian_filling" +filling+ "_" +pos+"_pressAwal", String.valueOf(pressAwal.getText()));
        prefManager.saveString("pengisian_filling" +filling+ "_" +pos+"_sm3Awal", String.valueOf(sm3Awal.getText()));
        ...
        else if (Float.valueOf(prefManager.catchString("pengisian_filling" + filling + "_" + pos + "_tekAwal")) <= 200 &&
                Float.valueOf(prefManager.catchString("pengisian_filling" + filling + "_" + pos + "_tekAwal")) >= 40) {
        ...
        noRak.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                ...
                short i = 1;
                while (i != 13) {
                    if (String.valueOf(noRak.getText()).contentEquals(prefManager.catchString("pengisian_filling" + filling + "_" + i + "_noRak"))) {
        ...
        noRak.setText(prefManager.catchString("pengisian_filling" +filling+ "_" +rak+"_noRak"));
        tekAwal.setText(prefManager.catchString("pengisian_filling" +filling+ "_" +rak+"_tekAwal"));
        tempAwal.setText(prefManager.catchString("pengisian_filling" +filling+ "_" +rak+"_tempAwal"));
        pressAwal.setText(prefManager.catchString("pengisian_filling" +filling+ "_" +rak+"_pressAwal"));
        sm3Awal.setText(prefManager.catchString("pengisian_filling" +filling+ "_" +rak+"_sm3Awal"));
//        Float.valueOf(prefManager.catchString("pengisian_filling1_tekAkhir"))
        tekAkhir.setText(prefManager.catchString("pengisian_filling"+filling+"_tekAkhir"));
        tempAkhir.setText(prefManager.catchString("pengisian_filling"+filling+"_tempAkhir"));
        pressAkhir.setText(prefManager.catchString("pengisian_filling"+filling+"_pressAkhir"));
        sm3Akhir.setText(prefManager.catchString("pengisian_filling"+filling+"_sm3Akhir"));
    ...
    private void fungsiReset() {
        ...
        try {
            while (i != 13) {
                prefManager.deleteKey("pengisian_filling" +filling+ "_" +i+"_noRak");
                prefManager.deleteKey("pengisian_filling" +filling+ "_" +i+"_tekAwal");
                prefManager.deleteKey("pengisian_filling" +filling+ "_" +i+"_tempAwal");
                prefManager.deleteKey("pengisian_filling" +filling+ "_" +i+"_pressAwal");
                prefManager.deleteKey("pengisian_filling" +filling+ "_" +i+"_sm3Awal");
            ...
            i = 1;
            while (i != 11) {
                prefManager.deleteKey("pengisian_filling1_compressor" + i);
                i++;
            }
            prefManager.deleteKey("pengisian_filling"+filling+"_tekAkhir");
            prefManager.deleteKey("pengisian_filling"+filling+"_tempAkhir");
            prefManager.deleteKey("pengisian_filling"+filling+"_pressAkhir");
            prefManager.deleteKey("pengisian_filling"+filling+"_sm3Akhir");
    ...
    private void fungsiAwal () {
        ...
        while (i != 13) {
            ...
            else if (Float.valueOf(prefManager.catchString("pengisian_filling" + filling + "_" + i + "_tekAwal")) <= 200 &&
                    Float.valueOf(prefManager.catchString("pengisian_filling" + filling + "_" + i + "_tekAwal")) >= 40) {
        ...
        while (i != 11) {
            ...
            compressor.setChecked(prefManager.catchBoolean("pengisian_filling"+filling+"_compressor" + i));
            i++;
        }
        ...
        try {
            while (i != 11) {
                ...
                if (compressor.isChecked()) {
                    ...
                    prefManager.saveBoolean("pengisian_filling1_compressor" + i, true);
                }
                else
                    prefManager.deleteKey("pengisian_filling1_compressor" + i);
            ...
            prefManager.saveString("pengisian_filling1_compressor", statusCompressor);
...
//            prefManager.saveString("pengisian_filling1_tekAkhir", String.valueOf(tekAkhir.getText()));
//            prefManager.saveString("pengisian_filling1_tempAkhir", String.valueOf(tempAkhir.getText()));
//            prefManager.saveString("pengisian_filling1_pressAkhir", String.valueOf(pressAkhir.getText()));
//            prefManager.saveString("pengisian_filling1_sm3Akhir", String.valueOf(sm3Akhir.getText()));
//            prefManager.saveString("pengisian_filling1_keterangan", String.valueOf(keterangan.getText()));
            //prefManager.saveString("pengisian_filling1_sm3Akhir", keterangan.getText().toString());
        }
...
//                                    zero.setText("0");
                                if (prefManager.catchString("pengisian_filling" + filling + "_" + i + "_tekAwal").contentEquals(""))
                                    prefManager.saveString("pengisian_filling" +filling+ "_" +i+"_tekAwal", "0");
                                if (prefManager.catchString("pengisian_filling" + filling + "_" + i + "_tempAwal").contentEquals(""))
                                    prefManager.saveString("pengisian_filling" +filling+ "_" +i+"_tempAwal", "0");
                                if (prefManager.catchString("pengisian_filling" + filling + "_" + i + "_pressAwal").contentEquals(""))
                                    prefManager.saveString("pengisian_filling" +filling+ "_" +i+"_pressAwal", "0");
                                if (prefManager.catchString("pengisian_filling" + filling + "_" + i + "_sm3Awal").contentEquals(""))
                                    prefManager.saveString("pengisian_filling" +filling+ "_" +i+"_sm3Awal", "0");
                            }
...
//                            temp_akhir pressure_akhir SM3_akhir keterangan
                            ...
                            while (i != 9) {
                                ...
                                //convert(datetime, '" + prefManager.catchString("pengisian_filling1_timeAkhir") + "', 103)
                                query = "insert into tp.pengisian_gas " +
                                        ...
                                        prefManager.catchString("pengisian_filling" +filling+ "_" +i+"_noRak")  + "', " +
                                        "?, " + //jenis_moda
                                        "?, " + //tekAwal
                                        "?, " + //tekAkhir
                                        Float.valueOf(prefManager.catchString("pengisian_filling" +filling+ "_" +i+"_tempAwal")) + ", " +
                                        String.valueOf(tempAkhir.getText()) + ", " +
                                        Float.valueOf(prefManager.catchString("pengisian_filling" +filling+ "_" +i+"_pressAwal")) + ", " +
                                        String.valueOf(pressAkhir.getText()) + ", " +
                                        Float.valueOf(prefManager.catchString("pengisian_filling" +filling+ "_" +i+"_sm3Awal")) + ", " +
                                        String.valueOf(sm3Akhir.getText()) + ", " +
                                        "convert(date, '" + prefManager.catchString("pengisian_filling1_timeAwal") + "', 103), " +
                                        "convert(datetime, convert(datetime, '" + prefManager.catchString("pengisian_filling1_timeAwal") + "', 103), 108), "+
                                        "convert(date, '" + prefManager.catchString("pengisian_filling1_timeAkhir") + "', 103), " +
                                        "convert(datetime, convert(datetime, '" + prefManager.catchString("pengisian_filling1_timeAkhir") + "', 103), 108), " +
                                        "convert(time, convert(datetime, '10/02/1998 " + stopwatch.getText().toString() + "', 103), 108), '" +
                                        prefManager.catchString("pengisian_filling1_compressor") + "', '" +
                                        keterangan.getText().toString() + "' )";

                                preparedStatement = con.prepareStatement(query);
                                preparedStatement.setString(1, "APV");
                                preparedStatement.setFloat(2, Float.valueOf(prefManager.catchString("pengisian_filling" +filling+ "_" +i+"_tekAwal")));
...
//        #FPV =SQRT(B/D-D+I/(3*P2))/(1+0,00132/(T2^3,25))
            ...
            double lwc;
            if (signRakApv >= 1 && signRakApv <= 8)
                lwc =  Double.parseDouble(prefManager.catchString("pengisian_filling1_apv_"+signRakApv+"_lwc"));
            else if (signRakCrane >= 9 && signRakCrane <= 11)
                lwc =  Double.parseDouble(prefManager.catchString("pengisian_filling1_crane_"+signRakCrane+"_lwc"));
            else
                lwc =  Double.parseDouble(prefManager.catchString("pengisian_filling1_trail_12_lwc"));
            double p1 = lwc / 1000;

            double sm3 = p1*(p0+1.01325)/1.01325*(273+27)/(273+t0)*Math.pow(fpv, 2);
            pressAwal.setText(String.format("%.2f", sm3));
            if (signRakApv >= 1 && signRakApv <= 8)
                prefManager.saveString("pengisian_filling1_apv_"+signRakApv+"_pressAwal", String.valueOf(pressAwal.getText()));
            else if (signRakCrane >= 9 && signRakCrane <= 11)
                prefManager.saveString("pengisian_filling1_crane_"+signRakCrane+"_pressAwal", String.valueOf(pressAwal.getText()));
            else
                prefManager.saveString("pengisian_filling1_trail_"+signRakTrailer+"_pressAwal", String.valueOf(pressAwal.getText()));
                ...
                if (con == null) {
                    ...
                    while (rs.next()) {
                        ...
                        if (signRakApv >= 1 && signRakApv <= 8)
                            ...
                            prefManager.saveString("pengisian_filling1_apv_" + signRakApv + "_lwc", rs.getString("LWC").toString());
                        else if (signRakCrane >= 9 && signRakCrane <= 11)
                            prefManager.saveString("pengisian_filling1_crane_" + signRakCrane + "_lwc", rs.getString("LWC").toString());
                        else
                            prefManager.saveString("pengisian_filling1_trail_12_lwc", rs.getString("LWC").toString());
...
//        #FPV =SQRT(B/D-D+I/(3*P2))/(1+0,00132/(T2^3,25))
                ...
                if (signRakApv >= 1 && signRakApv <= 8)
                    prefManager.saveString("pengisian_filling1_apv_"+signRakApv+"_pressAkhir", String.valueOf(pressAwal.getText()));
                else if (signRakCrane >= 9 && signRakCrane <= 11)
                    prefManager.saveString("pengisian_filling1_crane_"+signRakCrane+"_pressAkhir", String.valueOf(pressAwal.getText()));
                else
                    prefManager.saveString("pengisian_filling1_trail_"+signRakTrailer+"_pressAkhir", String.valueOf(pressAwal.getText()));
            } catch (Exception ex) {
                Toast.makeText(getActivity(), ex.getMessage(), Toast.LENGTH_SHORT).show();
            }
